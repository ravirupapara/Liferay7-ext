...
public class UserLocalServiceImpl extends UserLocalServiceBaseImpl {
	...
	public User addUserWithWorkflow(
			...
			ServiceContext serviceContext)
		throws PortalException {
		_log.info("EXT_ADDUSERWITHWORKFLOW");
		// User
	...
	public int authenticateByEmailAddress(
		...
		throws PortalException {
		_log.info("EXT_AUTHENTICATEBYEMAILADDRESS");
		return authenticate(
	...
	public User deleteUser(long userId) throws PortalException {
		User user = userPersistence.findByPrimaryKey(userId);
		System.out.println("EXT plugin :: deleteUser by Id");
		_log.info("EXT_DELETEUSER");
	...
	public User deleteUser(User user) throws PortalException {
		System.out.println("EXT plugin :: deleteUser by user");
		_log.info("EXT_DELETEUSER");
	...
	public User updateScreenName(long userId, String screenName)
		throws PortalException {
		_log.info("EXT_UPDATESCREENNAME");
		// User
	...
	@Override
	public User fetchUserByReferenceCode(long arg0, String arg1) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public int getOrganizationsAndUserGroupsUsersCount(long[] arg0, long[] arg1) {
		// TODO Auto-generated method stub
		return 0;
	}
